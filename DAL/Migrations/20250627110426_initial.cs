        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Car_DailyRate", "DailyRate > 0");
                    table.CheckConstraint("CK_Car_HourlyRate", "HourlyRate > 0");
                    table.CheckConstraint("CK_Car_Seats", "Seats > 0");
                    table.CheckConstraint("CK_Car_Year", "Year >= 1886");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FinalCharge = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InspectionReports", x => x.Id);
                    table.CheckConstraint("CK_Damage_RepairCost", "RepairCost > 0");
                    table.CheckConstraint("CK_InspectionReport_FinalCharge", "FinalCharge >= 0");
                    table.CheckConstraint("CK_InspectionReport_Mileage", "Mileage >= 0");
                });
